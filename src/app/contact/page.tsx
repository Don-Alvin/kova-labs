...
export const metadata: Metadata = pageMetadata({
  ...
  title: "Contact",
  description:
    "Book a free call with KovaLab, or reach us on WhatsApp and email. Based in Kisumu, working across East Africa.",
});
        ...
        <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-[1fr_320px] lg:gap-16">
          ...
          <aside className="flex flex-col gap-8 bg-bg p-6 text-left shadow-[var(--shadow-lift)]">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-text">Kisumu, Kenya</p>
