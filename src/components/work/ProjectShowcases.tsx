...
export const ProjectShowcases = ({ detailed = false, urls }: { detailed?: boolean; urls?: readonly string[] }) => (
      <div className="mt-10 flex flex-col gap-5 md:mt-12 md:gap-6">
        {PROJECTS.filter(project => !urls || urls.includes(project.url)).map((project, index) => (
